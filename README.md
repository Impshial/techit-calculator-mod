...
1. Build `techit-build-list-0.2.0.jar` using the instructions below.
...
The output is `techit-build-list-0.2.0.jar`, compiled as Java 7 bytecode. Only this mod's own classes and metadata are distributed; generated Minecraft/Forge compile dependencies remain ignored local build files.
