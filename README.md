...
This repository contains only the Minecraft mod, its build tools, tests, and format documentation. The calculator website is maintained separately in [Impshial/techedup](https://github.com/Impshial/techedup).

## Install

1. Build `teched-up-build-list-0.4.0.jar` using the instructions below.
...
The output is `teched-up-build-list-0.4.0.jar`, compiled as Java 7 bytecode. Only this mod's own classes and metadata are distributed; generated Minecraft/Forge compile dependencies remain ignored local build files.
